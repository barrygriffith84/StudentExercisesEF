...
namespace StudentExercises_EF.Controllers
{
    public class InstructorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,SlackHandle,CohortId,Specialty")] Instructor instructor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,SlackHandle,CohortId,Specialty")] Instructor instructor)
        {
            if (id != instructor.Id)
            {
                return NotFound();
